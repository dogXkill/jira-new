 ...
 */
 include("../config.php");
$conf['mysql_db'] = DB_DATABASE;
$conf['mysql_user'] = DB_USERNAME;
$conf['mysql_pw'] = DB_PASSWORD;
$conf['mysql_host'] = DB_HOSTNAME;
/**
 * Access to the comet server
 * Get access keys here https://comet-server.com/#price
 */
$conf['cometQL_dev_id'] = 3535;
$conf['cometQL_key'] = "8tdeZfLtWCtXUmdcXtKPGtcya3QJ4WMvxLV5zxbyZibCkxwPPPiosYZPSOL6SxNT";
 ...
 */
$conf['URL_getUsersHash'] = 'https://jira-new/chat/backend-example/chat_get_user_hash.php';
/**
 * URL to request information about users in json
 * Used only in getUsersInfo
 */
$conf['URL_getUsersInfo'] = 'https://jira-new/chat/backend-example/chat_get_users.php';
